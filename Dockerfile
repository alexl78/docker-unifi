...
ENV PKGURL=https://www.ubnt.com/downloads/unifi/5.6.10-f6637e5b6d/unifi_sysvinit_all.deb
...
CMD ["/bin/bash", "-c", "chown -R unifi:unifi /var/lib/unifi /var/run/unifi /var/log/unifi && /etc/init.d/unifi start && exec /bin/bash"]
